  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute w-96 h-96 rounded-full border border-gold"
      />
      ...
      <div className="relative z-10 text-center">
        <motion.p
          ...
          className="text-gold text-[10px] tracking-[0.6em] mb-6"
        >
          SINCE 1974
        </motion.p>
          ...
          <div className="flex justify-center">
            {letters.map((char, i) => (
              <motion.span
                ...
                className="font-display text-5xl md:text-7xl text-white tracking-widest inline-block"
              >
                {char === ' ' ? ' ' : char}
              </motion.span>
            ))}
        ...
        <motion.p
          ...
          className="text-gray-500 text-[10px] tracking-[0.5em]"
        >
          LUXURY JEWELLERY
        </motion.p>
      </div>
      ...
      <div className="absolute bottom-16 left-1/2 -translate-x-1/2 w-48">
        ...
        <motion.p
          ...
          className="text-center text-gray-600 text-[10px] mt-3 tracking-widest"
        >
